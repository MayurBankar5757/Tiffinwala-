...
public class VendorSubscriptionPlanController {
    ...
    @PostMapping(value = "/vsp/uploadImage/{vid}", consumes = "multipart/form-data")
    ...
    @GetMapping("/vsp/vendor/{vendorId}")
    ...
    @GetMapping("/vsp/getAllSubcriptionPlan")
    ...
    @PutMapping("/vsp/{planId}/disabled")
    ...
    @GetMapping("/vsp/filter/1000-5000")
    ...
    @GetMapping("/vsp/vendor/{vendorId}/enabled")
    ...
    @GetMapping("/vsp/vendor/{vendorId}/disabled")
